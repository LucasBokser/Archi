    ...
    return (
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" className="nav">
            ...
            <li><a className="smoothscroll" href="#about">A propos</a></li>
             <li><a className="smoothscroll" href="#pictures">Photos</a></li>
	         <li><a className="smoothscroll" href="#resume">Mon cv</a></li>
            <li><a className="smoothscroll" href="#portfolio">Mon travail</a></li>
      ...
      <div className="row banner">
         <div className="banner-text">
            ...
            <h3>Je viens de {city} je suis <span>{occupation}</span>. {description}.</h3>
            <hr />
            <ul className="social">
               {networks}
            </ul>
